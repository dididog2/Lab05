  ...
  return (
    <header className="bg-gray-100">
      <nav className="mx-auto flex items-center justify-start p-4" aria-label="Global">
        ...
        <div href="/about" className="text-sm font-semibold leading-6 text-gray-900 mx-6">
          About
        </div>
        <div href="/notes" className="text-sm font-semibold leading-6 text-gray-900 mx-6">
          Notes
        </div>
      </nav>
    </header>
